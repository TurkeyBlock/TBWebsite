...
export const Sidebar = ({tableName, setGameId, setGameKey, setInLobby, inLobby}:Props) => {
    ...
    return (
        <div className={styles.sidebar}>
            {/* sidebar flexbox*/}
            <div id="contents" className={styles.sidebarContents} style={{marginLeft: sidebar?``:-`${sidebarWidth}`, maxHeight: sidebar?`100dvw`:`10vw`, transition:("margin-left .5s ease 0s, max-height 0s ease ").concat(sidebar?"0s":".5s")}}>
